...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        add_student_action = QAction(QIcon("icons/add.png"), "Add Student", self)                           #Self argument will connect QAction to the actual class
        ...
        #Create toolbar and add search elements
        search_bar = QToolBar()
        search_bar.setMovable(True)
        self.addToolBar(search_bar)
        search_bar.addAction(search_action)
    ...
    def cell_clicked(self):
        ...
        #Removes multiple edit and delete dialouge
    ...
    #Instantiate an edit dialogue class
    def edit(self):
        dialog = EditDialog()
        dialog.exec()
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created while finishing Python App course
        """
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        layout = QGridLayout()
        confirmation = QLabel("Sure to delete?")
        yes = QPushButton("Yes")
        no = QPushButton("No")
